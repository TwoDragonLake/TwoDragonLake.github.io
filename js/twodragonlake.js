...
console.log("二龙湖基地组织Geek，技术控集聚地");
console.log("   - 提倡包括但不限于以文字、图片、视频、音频、代码（提倡开源）、链接（提倡技术）、红包等形式技术分享");
console.log("   - 提倡相互推荐善于技术交流互动、技术控的人员入群");
console.log("   - 提倡讨论生命、宇宙、人生理想、资本主义、物理学说、大自然、黑科技、人工智能，机器人，无人机，医疗尤其是提倡【创业】类话题、技术讨论聚会等");
